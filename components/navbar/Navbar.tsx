...
function Navbar() {
  return (
    <nav className="border-b border-gray-500 border-gray-700">
      <div className="container absolute top-1 left-1/2 transform -translate-x-1/2 flex justify-between items-center py-8 gap-2">
